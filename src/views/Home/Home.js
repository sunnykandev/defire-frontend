...
import CashImage from "../../assets/img/defirewhite.svg";
        ...
        <Grid item xs={12} sm={8}>
          <Paper style={{ backgroundColor: "transparent", boxShadow: "none", border: "1px solid var(--white)" }}>
            <Box p={4}>
              ...
              <p>
                3omb utilizes multiple bonding mechanisms at the <StyledLink href='/'>3DAO</StyledLink> as well as seigniorage.
              </p>
              <p>
                Built on top of{" "}
              ...
              <p>
                Stake your 3OMB-WFTM LP in the <StyledLink href='/farms'>3Farms</StyledLink> to earn 3SHARES rewards. Then stake your earned 3SHARES in the{" "}
                <StyledLink href='/'>3Room</StyledLink> to maximize profits!
              </p> */}
            </Box>
          </Paper>
        </Grid>
        ...
        {/* <Grid container justify='center'>
          <Box mt={3} style={{ width: "1000px" }}>
            <Alert variant='filled' severity='warning'>
              Do your own research before investing. Investing is risky and may result in monetary loss. 3omb is beta software and may contain bugs. By using 3omb, you agree that
              the 2omb and 3omb team is not responsible for any financial losses from investing in 2omb or 3omb.
            </Alert>
          </Box>
        </Grid> */}
        ...
        <Grid item xs={12} sm={3}>
          <Card style={{ backgroundColor: "transparent", boxShadow: "none", border: "1px solid var(--white)" }}>
            <CardContent align='center' style={{ position: "relative" }}>
              ...
              <Box>
                <span style={{ fontSize: "16px", alignContent: "flex-start" }}>${tombPriceInDollars ? tombPriceInDollars : "-.--"}</span>
              </Box>
              <span style={{ fontSize: "12px" }}>
            ...
            <CardContent align='center'>
              ...
              <Box mt={2}>
                <span style={{ fontSize: "26px" }}>
                  {tombLPStats?.tokenAmount ? tombLPStats?.tokenAmount : "-.--"} 3OMB / {tombLPStats?.ftmAmount ? tombLPStats?.ftmAmount : "-.--"} FTM
                </span>
              </Box>
        ...
        <Grid item xs={12} sm={6}>
          <Card style={{ backgroundColor: "transparent", boxShadow: "none", border: "1px solid var(--white)" }}>
            <CardContent align='center'>
              ...
              <Box mt={2}>
                <span style={{ fontSize: "26px" }}>
                  {tshareLPStats?.tokenAmount ? tshareLPStats?.tokenAmount : "-.--"} 3SHARE / {tshareLPStats?.ftmAmount ? tshareLPStats?.ftmAmount : "-.--"} FTM
                </span>
              </Box>
